...
const Home = () => {
  ...
  return (
    <>
      <div
        className={`justify-center bg-no-repeat bg-cover bg-center rounded-lg capital`}
      >
        <main className="">
            ...
            <div className="mx-auto max-w-xl py-24 sm:py-32 lg:py-40">
              <div className="text-center">
                ...
                <p className="mt-6 text-5xl leading-8 text-black-900">
                  <strong>
                    In a country troubled with wars, hatred, and evil, we call
                    on <strong>YOU</strong> to join the movement for civility
                    and honor in our nation.
                  </strong>
                </p>
                    ...
                    <strong>
                      <span>
                        <a
                          ...
                          href="https://yournews.com/2025/09/12/3868302/campaignforcivility-com-launches-nationwide-movement/"
                          className="underline"
                        >
                          featured article
                        </a>
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <Link
                    to="/letter-clarion-call-for-civility"
